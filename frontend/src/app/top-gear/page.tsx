      ...
      <div className="card flex flex-col gap-4 p-5 sm:flex-row">
        <label className="group flex flex-1 cursor-pointer items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-300">Apply equipped enchants to alternatives</p>
          </div>
        </label>
        <label className="group flex flex-1 cursor-pointer items-center gap-3">
          <div
          ...
          <div>
            ...
            <p className="text-sm text-zinc-300">Simulate all items at max upgrade level</p>
          </div>
        </label>
